...
export default function Sidebar({ 
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-white/10 bg-slate-950/45 backdrop-blur-xl text-slate-300 shadow-2xl">
      {/* Platform Branding */}
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`group flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-xs font-semibold tracking-normal transition-all duration-200 cursor-pointer ${
                isActive
      ...
      <div className="p-4 border border-white/10 m-4 rounded-xl bg-white/[0.03] backdrop-blur-md text-left space-y-3">
      ...
      {/* Footer Branding of Lumiere (Removed 'Online' label) */}
      <div className="flex h-12 items-center justify-between px-6 border-t border-white/5 text-[10px] text-slate-400 font-mono">
